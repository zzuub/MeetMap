...
/**
 * 찜 성공 토스트 (7.2). 해제도 알린다.
 *
 * ⚠️ **찜 목록(9장)에서는 해제한 카드가 사라진다** — 다른 화면처럼 하트가 남아 다시
 * 누를 수 있는 자리가 아니다. 문구는 그대로 두고(참이다) 되돌리기는 9장 TBD 로 남겼다.
 * 토스트가 결과 확인인 것도 그대로다 (`decisions.md` 4.61·4.64).
 */

 ...
 * 스켈레톤과 탐색 스켈레톤은 실제로 다르다. **퍼널 넷은 그 근거가 성립하지 않는다.**
 * 넷 다 제목 한 줄 + 입력 블록 + 하단 버튼이고, 스켈레톤으로 흉내낼 콘텐츠 모양이
 * 없다. 넷으로 복사하면 같은 파일이 넷이 된다 (`decisions.md` 4.47).
 *
 * 실제로 폴백이 뜨는 자리는 `/onboarding/done` 하나다 — 나머지 셋은 조회가 없다.
 */
